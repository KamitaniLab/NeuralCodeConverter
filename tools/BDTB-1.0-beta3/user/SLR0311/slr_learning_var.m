function [w, ix_eff, W, AX] = slr_learning_var(label, X, varargin)
...
%
% -- Usage 
% [w, ix_eff, W, AX] = slr_learning_var(label, X, varargin)
% 
% -- Input
...
% nohesssian : If 1 (TRUE), the diagonal elements of posterior variance is calculated without   
