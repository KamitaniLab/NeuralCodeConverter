function [ww, ix_eff_all, errTable_tr, errTable_te, parm, AXall,Ptr,Pte] =...
    run_smlr_bi_var(x_train, t_train, x_test, t_test, varargin)
% Run sparse multinomial logistic regression using combinations of binary
% classifier (variational parameters implmentation).
% 
% -- Usage
...
for c = 1 : Nclass
    ...
    if c == Nclass & reduceparm
        ...
        [w_e, ix_eff, W, AX] = slr_learning_var(label, Xtr,...
            'nlearn', Nlearn, 'nstep', Nstep, 'amax', AMAX, 'nohesssian', nohesssian);
